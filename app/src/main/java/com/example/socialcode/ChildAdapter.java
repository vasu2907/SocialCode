...
public class ChildAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ChildAdapter(ArrayList<Child> childData, String category) {
...
//            vh.tvChild.setBackgroundColor(Color.WHITE);
            vh.tvChild.setTextSize(15);

        }else if(position == 0 && getItemCount() > 1){
